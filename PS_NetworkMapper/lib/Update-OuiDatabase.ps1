...
# truncate or corrupt the existing (checked-into-git) vendored asset at $OutputPath. Shared
# with the rest of the app's atomic-write call sites via FileHelpers.ps1 (dot-sourced above).
